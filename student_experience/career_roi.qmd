...
// $63,000 = NIH NRSA postdoc minimum stipend (FY2024); used as postdoc salary floor
roi_postdoc_extra_cost = Math.round(Math.max(0, roi_alt_salary - 63000) * roi_postdoc_years)
...
Plot.plot({
  ...
  color: {
    domain: ["No Postdoc", "With " + roi_postdoc_years + "-yr Postdoc"].filter((v, i, a) => a.indexOf(v) === i),
    range: ["#3498db", "#9b59b6"],
    legend: true
  },
  marks: [
